...
> **Last Updated:** 2026-09-25 10:39 UTC
...
| 2 | [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | 510.2k | `N/A` | 😎 Awesome lists about all kinds of interesting topics [NOTE: Pull requests ar... |
| 3 | [public-apis/public-apis](https://github.com/public-apis/public-apis) | 483.0k | `Python` | A collective list of free APIs |
...
| 6 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | 390.5k | `TypeScript` | The AI that really does things. Any OS. Any Platform. The lobster way. 🦞  |
| 7 | [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | 371.7k | `Python` | Learn how to design large-scale systems. Prep for the system design interview... |
| 8 | [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | 368.1k | `TypeScript` | Interactive roadmaps, guides and other educational content to help developers... |
...
| 10 | [vinta/awesome-python](https://github.com/vinta/awesome-python) | 322.9k | `Python` | The definitive list that answers "I want to do X in Python, which tool should... |
...
| 12 | [obra/superpowers](https://github.com/obra/superpowers) | 291.4k | `Shell` | An agentic skills framework & software development methodology that works. |
...
| 15 | [mattpocock/skills](https://github.com/mattpocock/skills) | 269.3k | `Shell` | Skills for Real Engineers. Straight from my .agents directory. |
| 16 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 267.2k | `JavaScript` | The agent harness performance optimization system. Skills, instincts, memory,... |
...
| 19 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 248.8k | `Python` | The agent that grows with you |
...
| 21 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 235.6k | `TypeScript` | DeepSeek Harness: Everything is a Plugin. |
| 22 | [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | 225.0k | `Python` | All Algorithms implemented in Python |
| 23 | [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | 215.1k | `N/A` | A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej ... |
...
| 28 | [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | 201.1k | `Markdown` | Free domain registration and practical DNS learning resources for everyone. |
...
| 32 | [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) | 193.5k | `Python` | A feature-rich command-line audio/video downloader |
...
| 37 | [microsoft/markitdown](https://github.com/microsoft/markitdown) | 187.0k | `Python` | Python tool for converting files and office documents to Markdown. |
...
| 42 | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | 184.5k | `TypeScript` | The web data API to search, scrape, and interact at scale. 🔥 |
...
| 45 | [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | 178.5k | `Python` | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source p... |
| 46 | [anthropics/skills](https://github.com/anthropics/skills) | 178.1k | `Python` | Public repository for Agent Skills |
...
| 54 | [langgenius/dify](https://github.com/langgenius/dify) | 157.2k | `TypeScript` | Build Agentic workflows, RAG pipelines, with rich AI model and tool support o... |
...
| 56 | [msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents) | 154.6k | `Shell` | A complete AI agency at your fingertips - From frontend wizards to Reddit com... |
...
| 61 | [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | 147.2k | `Rust` | A modern GUI client based on Tauri, designed to run in Windows, macOS and Lin... |
| 62 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | 147.0k | `Python` | The agent engineering platform. |
| 63 | [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) | 145.7k | `JavaScript` | Makes your AI agent think like the laziest senior dev in the room. The best c... |
...
| 73 | [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) | 138.4k | `HTML` | A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to d... |
| 74 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 136.7k | `Rust` | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCod... |
...
| 78 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 132.9k | `TypeScript` | Virtual whiteboard for sketching hand-drawn like diagrams |
| 79 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 130.5k | `Python` | An AI skill that provides design intelligence for building professional UI/UX... |
...
| 86 | [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) | 125.6k | `Python` | 利用 AI 大模型和自动化工作流，根据主题或关键词一键生成高清短视频。Generate HD short videos from a topic or k... |
...
| 91 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 121.3k | `Python` | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a quer... |
...
| 98 | [2dust/v2rayN](https://github.com/2dust/v2rayN) | 117.0k | `C#` | A GUI client for Windows, Linux and macOS, support Xray and sing-box and others |
...
| Rank | Repository | Stars | Language | Description |
|:---:|:---|:---:|:---:|:---|
| 1 | [public-apis/public-apis](https://github.com/public-apis/public-apis) | 483.0k | `Python` | A collective list of free APIs |
...
| 3 | [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | 371.7k | `Python` | Learn how to design large-scale systems. Prep for the system design interview... |
| 4 | [vinta/awesome-python](https://github.com/vinta/awesome-python) | 322.9k | `Python` | The definitive list that answers "I want to do X in Python, which tool should... |
...
| 6 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 248.8k | `Python` | The agent that grows with you |
| 7 | [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | 225.0k | `Python` | All Algorithms implemented in Python |
| 8 | [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) | 193.5k | `Python` | A feature-rich command-line audio/video downloader |
...
| 10 | [microsoft/markitdown](https://github.com/microsoft/markitdown) | 187.0k | `Python` | Python tool for converting files and office documents to Markdown. |
| 11 | [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | 178.5k | `Python` | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source p... |
| 12 | [anthropics/skills](https://github.com/anthropics/skills) | 178.1k | `Python` | Public repository for Agent Skills |
...
| 22 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 130.5k | `Python` | An AI skill that provides design intelligence for building professional UI/UX... |
| 23 | [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) | 125.6k | `Python` | 利用 AI 大模型和自动化工作流，根据主题或关键词一键生成高清短视频。Generate HD short videos from a topic or k... |
| 24 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 121.3k | `Python` | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a quer... |
...
| 35 | [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) | 92.7k | `Python` | Hunt down social media accounts by username across social networks |
...
| 41 | [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | 85.4k | `Python` | Give your AI agent eyes to see the entire internet. Read & search Twitter, Re... |
...
| 43 | [unclecode/crawl4ai](https://github.com/unclecode/crawl4ai) | 84.2k | `Python` | Open-source web crawler and scraper for LLMs and AI agents: any website into ... |
| 44 | [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 83.6k | `Python` | 🕷️ An adaptive Web Scraping framework that handles everything from a single r... |
...
| 62 | [666ghj/MiroFish](https://github.com/666ghj/MiroFish) | 74.6k | `Python` | A Simple and Universal Swarm Intelligence Engine, Predicting Anything. 简洁通用的群... |
...
| 64 | [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) | 73.8k | `Python` | Compress tool outputs, logs, files, and RAG chunks before they reach the LLM.... |
...
| 77 | [usestrix/strix](https://github.com/usestrix/strix) | 64.7k | `Python` | Open-source AI penetration testing tool to find and fix your app’s vulnerabil... |
...
| Rank | Repository | Stars | Language | Description |
|:---:|:---|:---:|:---:|:---|
| 1 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 267.2k | `JavaScript` | The agent harness performance optimization system. Skills, instincts, memory,... |
...
| 6 | [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) | 145.7k | `JavaScript` | Makes your AI agent think like the laziest senior dev in the room. The best c... |
...
| 14 | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 99.0k | `JavaScript` | Production-grade engineering skills for AI coding agents. |
...
| 18 | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) | 90.0k | `JavaScript` | Taste-Skill - gives your AI good taste. stops the AI from generating boring, ... |
...
| 24 | [career-ops-hq/career-ops](https://github.com/career-ops-hq/career-ops) | 72.7k | `JavaScript` | Open-source AI job search: scan job portals, evaluate listings into a structu... |
| 25 | [hakimel/reveal.js](https://github.com/hakimel/reveal.js) | 72.3k | `JavaScript` | The HTML Presentation Framework |
| 26 | [tt-a1i/archify](https://github.com/tt-a1i/archify) | 71.4k | `JavaScript` | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-... |
| 27 | [pbakaus/impeccable](https://github.com/pbakaus/impeccable) | 70.9k | `JavaScript` | The design language that makes your AI harness better at design. |
...
| 52 | [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills) | 51.5k | `JavaScript` | Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analyt... |
...
| 74 | [bilawalsidhu/gods-eye-view](https://github.com/bilawalsidhu/gods-eye-view) | 42.7k | `JavaScript` | A spy satellite simulator in your browser, except the data is real. Live open... |
...
| 2 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | 390.5k | `TypeScript` | The AI that really does things. Any OS. Any Platform. The lobster way. 🦞  |
| 3 | [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | 368.1k | `TypeScript` | Interactive roadmaps, guides and other educational content to help developers... |
| 4 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 235.6k | `TypeScript` | DeepSeek Harness: Everything is a Plugin. |
...
| 9 | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | 184.5k | `TypeScript` | The web data API to search, scrape, and interact at scale. 🔥 |
| 10 | [langgenius/dify](https://github.com/langgenius/dify) | 157.2k | `TypeScript` | Build Agentic workflows, RAG pipelines, with rich AI model and tool support o... |
...
| 15 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 132.9k | `TypeScript` | Virtual whiteboard for sketching hand-drawn like diagrams |
...
| 19 | [earendil-works/pi](https://github.com/earendil-works/pi) | 109.3k | `TypeScript` | AI agent toolkit: unified LLM API, agent loop, TUI, coding agent CLI |
...
| 37 | [paperclipai/paperclip](https://github.com/paperclipai/paperclip) | 83.2k | `TypeScript` | The open-source app everyone uses to manage agents at work |
...
| 42 | [stablyai/orca](https://github.com/stablyai/orca) | 77.9k | `TypeScript` | Orca is the ADE for working with a fleet of parallel agents. Run any coding a... |
...
| 46 | [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 73.2k | `TypeScript` | 🌊 The original agent harness. Deploy intelligent multi-player swarms, coordin... |
...
| 49 | [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | 70.3k | `TypeScript` | Spec-driven development (SDD) for AI coding assistants. |
...
| 62 | [remotion-dev/remotion](https://github.com/remotion-dev/remotion) | 60.4k | `TypeScript` | 🎥      Make videos programmatically with React |
...
| 69 | [jamiepine/voicebox](https://github.com/jamiepine/voicebox) | 55.7k | `TypeScript` | The open-source AI voice studio. Clone, dictate, create. |
...
| 74 | [heygen-com/hyperframes](https://github.com/heygen-com/hyperframes) | 53.0k | `TypeScript` | Write HTML. Render video. Built for agents. |
...
| 99 | [fastapi/full-stack-fastapi-template](https://github.com/fastapi/full-stack-fastapi-template) | 45.8k | `TypeScript` | Full-stack web application template with FastAPI, React, SQLModel, PostgreSQL... |
...
| 7 | [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | 107.8k | `Go` | 🪨 why use many token when few token do trick. Viral skill + proxy for coding ... |
...
| 37 | [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui) | 46.9k | `Go` | Supporting multi-protocol multi-user(Vmess, Vless, Trojan, ShadowSocks, Wireg... |
...
| 46 | [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) | 42.7k | `Go` | Sub2API 一站式开源中转服务，让 Claude、Openai 、Gemini、Grok订阅统一接入，支持拼车共享，更高效分摊成本，原生工具无缝使用。 |
...
| 48 | [alibaba/open-code-review](https://github.com/alibaba/open-code-review) | 41.1k | `Go` | Secure, fast, efficient, battle-tested at Alibaba's scale. Hybrid architectur... |
...
| 95 | [Tencent/WeKnora](https://github.com/Tencent/WeKnora) | 29.9k | `Go` | Open-source LLM knowledge platform: turn raw documents into a queryable RAG, ... |
...
| 2 | [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | 147.2k | `Rust` | A modern GUI client based on Tauri, designed to run in Windows, macOS and Lin... |
| 3 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 136.7k | `Rust` | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCod... |
...
| 10 | [ruvnet/RuView](https://github.com/ruvnet/RuView) | 95.0k | `Rust` | π RuView turns commodity WiFi signals into real-time spatial intelligence, vi... |
...
| 36 | [juspay/hyperswitch](https://github.com/juspay/hyperswitch) | 44.0k | `Rust` | Open source, composable payments platform \| PCI compliant \| SaaS and Self-h... |
...
| 42 | [herdrdev/herdr](https://github.com/herdrdev/herdr) | 40.7k | `Rust` | the runtime your coding agents live on |
...
| 57 | [block/buzz](https://github.com/block/buzz) | 34.4k | `Rust` | A hive mind communication platform |
...
| 62 | [rustfs/rustfs](https://github.com/rustfs/rustfs) | 33.9k | `Rust` | RustFS is an open-source, S3-compatible high-performance object storage syste... |
...
| Rank | Repository | Stars | Language | Description |
|:---:|:---|:---:|:---:|:---|
| 1 | [2dust/v2rayN](https://github.com/2dust/v2rayN) | 117.0k | `C#` | A GUI client for Windows, Linux and macOS, support Xray and sing-box and others |
...
| 14 | [k1tbyte/Wand-Enhancer](https://github.com/k1tbyte/Wand-Enhancer) | 29.1k | `C#` | Advanced UX and interoperability extension for Wand (WeMod) app |
...
| 3 | [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) | 138.4k | `HTML` | A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to d... |
...
| 7 | [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design) | 42.4k | `HTML` | Editorial diagram design for Claude Code, Codex, and Pi. Self-contained HTML ... |
...
| 21 | [op7418/guizang-ppt-skill](https://github.com/op7418/guizang-ppt-skill) | 26.9k | `HTML` | AI-agent Skill for generating polished HTML slide decks: editorial magazine a... |
...
| 52 | [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) | 16.5k | `HTML` | AI 时代的伯克希尔：基于 Claude Code / Codex 的价值投资研究框架。巴菲特·芒格·段永平·李录四大师方法论 + 多Agent并行研究。... |
...
| 61 | [eternity4719/HowToLiveBetter](https://github.com/eternity4719/HowToLiveBetter) | 15.2k | `HTML` | 按性价比排序的循证生活指南：长寿防病、急救、省钱理财、法律红线、失业与工伤、医保社保、恋爱婚育、怀孕育儿、创业与做平台合规、出国与技能。每条写明成本、收益... |
...
| 65 | [keiyoushi/extensions](https://github.com/keiyoushi/extensions) | 15.1k | `HTML` | Extension repository for Mihon and variants |
...
| 8 | [hehonghui/awesome-english-ebooks](https://github.com/hehonghui/awesome-english-ebooks) | 37.0k | `CSS` | 经济学人(含音频)、纽约客、卫报、连线、大西洋月刊等英语杂志免费下载,支持epub、mobi、pdf格式, 每周更新 |
...
| 16 | [zhishile/codex-auth-helper](https://github.com/zhishile/codex-auth-helper) | 16.7k | `CSS` | Codex登陆助手：安全地在本地导出您的已登录 ChatGPT 会话配置，生成符合 Codex 规范的 auth.json 本地备份文件。 |
...
|:---:|:---|:---:|:---:|:---|
| 1 | [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | 549.4k | `Markdown` | Master programming by recreating your favorite technologies from scratch. |
| 2 | [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | 201.1k | `Markdown` | Free domain registration and practical DNS learning resources for everyone. |
...
| 19 | [jakubkrehel/skills](https://github.com/jakubkrehel/skills) | 7.2k | `Markdown` | A collection of agent skills that help you build great interfaces. |
...
| 65 | [pallavi-shekhar/ai-engineering-interview-questions-company-wise](https://github.com/pallavi-shekhar/ai-engineering-interview-questions-company-wise) | 0.8k | `Markdown` | Your Cheat Sheet For AI Engineering Interviews at Top AI Companies - Question... |
